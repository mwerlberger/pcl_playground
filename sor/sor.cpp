...
//--------------------------------------------------------------------------------
pcl::PointCloud<PointNormalT>::Ptr filterSOR(pcl::PointCloud<PointNormalT>::Ptr cloud)
{
   std::cout << "entering filterSOR(cloud)" << std::endl;
   pcl::PointCloud<PointNormalT>::Ptr cloud_sor(new pcl::PointCloud<PointNormalT>());

   pcl::StatisticalOutlierRemoval<PointNormalT> sor;
